...
# Notas: Script de experimento LODO para CP (proteína bruta), usando Gradient Boosting (árvore), janela Δ7 dias (D7), apenas bandas/índices do S2, sem clima. Faz parte do painel de baselines oficiais do mestrado (UFMS).
...
# Para árvore, não vamos padronizar: passthrough
...
print("[INFO] Iniciando LODO por Date (GB)...")
...
print("\n[GLOBAL OOF - GB] R2={:.3f} | RMSE={:.3f} | MAE={:.3f}".format(
...
print(f"\n[OK] Métricas por fold + GLOBAL (GB) salvas em: {metrics_path}")
print(f"[OK] Predições OOF (GB) salvas em: {oof_path}")
