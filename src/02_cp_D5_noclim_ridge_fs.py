...
TARGET_COL = "CP"
DELTA_MAX_DAYS = 5  # D5
USE_CLIMATE = False  # noclim


def run_lodo_ridge():
    # === 1) Preparar X, y, df_filt com a função centralizada ===
    X, y, df = prepare_xy(
    ...
    print(
        f"\n[GLOBAL OOF - RIDGE_D{DELTA_MAX_DAYS}_{TARGET_COL}_NOCLIM_FS] "
    ...
    # === 4) Salvar CSVs ===
    scenario_tag = f"D{DELTA_MAX_DAYS}_{TARGET_COL}_noclim_ridge_fs"
