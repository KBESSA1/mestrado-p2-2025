...
# Notas: Script de experimento LODO para TDN_based_ADF (digestibilidade estrutural), usando baseline ingênuo (persistência), janela Δ7 dias (D7), apenas bandas/índices do S2, sem clima. Faz parte do painel de baselines oficiais do mestrado (UFMS).
...
SUFFIX = "D7_TDN_noclim_naive"  # identificador
