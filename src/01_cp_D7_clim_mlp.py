...
# Notas: Script de experimento LODO para CP (proteína bruta), usando MLP densa (rede neural), janela Δ7 dias (D7), com clima acoplado ao S2. Faz parte do painel de baselines oficiais do mestrado (UFMS).
