...
# Notas: Script de experimento LODO para CP (proteína bruta), usando lodo, janela Δ5 dias (D5), apenas bandas/índices do S2, sem clima. Faz parte do painel de baselines oficiais do mestrado (UFMS).
...
SUFFIX = "D5_CP_noclim_linear"  # vai no nome dos CSVs
