...
def main():
    ...
    if len(out_rows) == 0:
        ...
        # escreve QC mesmo sem linhas válidas, para diagnóstico
        ...
        try:
            ...
            has_item_vc = df_qc.get("has_item", pd.Series(dtype="float")).value_counts(dropna=False).to_dict()
        ...
        with open(qc_md, "w", encoding="utf-8") as f:
            ...
            f.write(f"has_item counts: {has_item_vc}\n")
